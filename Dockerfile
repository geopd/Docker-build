...
RUN pacman -Syyu --noconfirm \
    && pacman -S --noconfirm axel base-devel bc ccache clang cmake cpio git inetutils jdk8-openjdk lld llvm lzip multilib-devel nano patchelf python2 python3 rclone svn xmlto z3 zip \
