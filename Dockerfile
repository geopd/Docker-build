...
RUN pacman -Syyu --noconfirm \
    && pacman -S --noconfirm base-devel bc ccache clang cmake git inetutils jdk8-openjdk lld llvm lzip multilib-devel nano patchelf python2 python3 rclone svn z3 zip \
